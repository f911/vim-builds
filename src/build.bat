...
%VCX64NATIVEBIN%\nmake -f Make_mvc.mak SDK_INCLUDE_DIR=%WIN32MAKDIR% FEATURES=HUGE CPU=AMD64 GUI=yes OLE=yes DIRECTX=yes PERL=C:\Perl64 DYNAMIC_PERL=yes PERL_VER=524 PYTHON=C:\Python27 DYNAMIC_PYTHON=yes PYTHON_VER=27 PYTHON3=C:\Python36 DYNAMIC_PYTHON3=yes PYTHON3_VER=36 IME=yes GIME=yes CSCOPE=yes USERNAME=F911 USERDOMAIN=NERV
